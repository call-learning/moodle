...
class mod_instance_helper {
     ...
     **/
    public static function add_instance(stdClass $bigbluebuttonbn) {
        // Nothing for now.
    }
    /**
     ...
     * @param stdClass $bigbluebuttonbn BigBlueButtonBN form data
     **/
    public static function update_instance(stdClass $bigbluebuttonbn): void {
        // Nothing for now.
    }
     ...
     * @param int $cmid
     */
    public static function delete_instance(int $cmid): void {
    }
}
