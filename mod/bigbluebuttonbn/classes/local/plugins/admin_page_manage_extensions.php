...
class admin_page_manage_extensions extends admin_externalpage {
    ...
    public function __construct() {
        ...
        parent::__construct('manage' . extension::BBB_EXTENSION_PLUGIN_NAME . 'plugins',
            get_string('manage' . extension::BBB_EXTENSION_PLUGIN_NAME . 'plugins', 'mod_bigbluebuttonbn'),
            $url);
    }
